  ...
  for (j in seq_len(byteCount)) {
    ...
    for (i in 1:8) {
      if (direction == 1) {
        #UP
        if (
          (pointer[2] %% 2 == 1 & pointer[2] > 7) |
          (pointer[2] %% 2 == 0 & pointer[2] < 7)
        ) {
          ...
          if (data[pointer[1], pointer[2] - 1] == 0) {
            ...
            if (
              data[pointer[1] - 1, pointer[2]] == 95 |
              data[pointer[1] - 1, pointer[2]] == 55
            ) {
          ...
          if (pointer[1] != 1) {
            if (data[pointer[1] - 1, pointer[2] + 1] == 0) {
              ...
              if (
                data[pointer[1], pointer[2] - 1] == 55 |
                data[pointer[1], pointer[2] - 1] == 95
              ) {
              ...
              data[pointer[1] - 1, pointer[2] + 1] == 95 |
              data[pointer[1] - 1, pointer[2] + 1] == 55
            ) {
              #timing code
        ...
        if (
          ...
          if (pointer[1] != size) {
            if (data[pointer[1] + 1, pointer[2] + 1] == 0) {
              ...
              data[pointer[1] + 1, pointer[2] + 1] == 50 |
              data[pointer[1] + 1, pointer[2] + 1] == 40
            ) {
              pointer <- c(pointer[1], pointer[2] - 1)
              direction <- 1
            } else if (
